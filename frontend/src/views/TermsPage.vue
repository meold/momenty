  ...
  <div class="w-full rounded-2xl bg-white p-5 sm:p-20 text-slate-700 shadow-[0_8px_60px_0_rgba(0,0,0,0.05)]">
    ...
    <ol class="list-decimal">
      ...
      <li>
        ...
        <p>
          NFTS EXIST ONLY BY VIRTUE OF THE OWNERSHIP RECORD MAINTAINED IN THE ASSOCIATED BLOCKCHAIN (E.G., Polygon NETWORK). ANY TRANSFERS OR SALES OCCUR ON THE ASSOCIATED BLOCKCHAIN (E.G., Polygon). Momenty AND/OR ANY OTHER Momenty PARTY CANNOT EFFECT OR OTHERWISE CONTROL THE TRANSFER OF TITLE OR RIGHT IN ANY NFTS OR UNDERLYING OR ASSOCIATED CONTENT OR ITEMS.
        </p>
        <p>
