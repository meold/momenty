      ...
      <nav class="relative z-50 flex items-center justify-between gap-x-5 md:gap-x-8">
        <div class="flex grow items-center md:gap-x-12">
          ...
          <div class="grow hidden md:flex justify-center">
            <div v-if="true" class="relative w-full">
              <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
              </div>
              <input type="search" placeholder="Search by collection, NFT, username" class="w-full p-[13px] pl-10 border-2 rounded-xl border-gray-300 text-sm">
            </div>
            <form-kit
              v-else
              v-model="search"
              type="search"
              name="search"
              placeholder="Search by collection, NFT, username"
              outer-class="w-full mb-0"
              inner-class="p-[3px] outline-none"
            />
          </div>
        </div>
            ...
            <popover v-slot="{ open }">
              ...
              <transition-root>
                <transition-child
                  ...
                  leave-to="opacity-0"
                >
                  <popover-overlay class="fixed inset-0 bg-slate-300/50" />
                </transition-child>
                <transition-child
                  as="div"
                  enter="duration-150 ease-out"
                ...
                >
                  <popover-panel>
                    <popover-button as="a" class="menu-link" href="#FIXME:">
                    ...
                    <popover-button as="a" class="menu-link" href="#FIXME:">Token</popover-button>
                    <popover-button as="a" class="menu-link" href="#FIXME:">API</popover-button>
                    <popover-button as="a" class="menu-link" href="#FIXME:">Help center</popover-button>
